...
"""bdodatabase module can be installed and configured from here"""
...
setup(
    ...
    url='http://ntz-git.tk/IG/BDO-lib-igcore',
    download_url='http://ntz-git.tk/IG/BDO-lib-igcore/tarball/v{}'.format(
        VERSION),
    keywords=[
        'BlackDesert',
        'BlackDesertOnline',
